 ...
 */
public class NewestFragment extends Fragment implements RefreshRecyleView.OnLoadMoreListenter, XRecyclerView.LoadingListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //获取地址
        url = Cantents.CLISSIFTY_Item2_URl + "time";
