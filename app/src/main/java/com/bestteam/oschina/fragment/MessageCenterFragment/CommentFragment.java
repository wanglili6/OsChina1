...
import com.bestteam.oschina.adapter.CommentFragmentRVAdapter;
...
public class CommentFragment extends Fragment {
    private CommentFragmentRVAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_comment, container, false);
        xRecyclerView = (XRecyclerView) view.findViewById(R.id.rv_comment_message);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new CommentFragmentRVAdapter(getContext());
