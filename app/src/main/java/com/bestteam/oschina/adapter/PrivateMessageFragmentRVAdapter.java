   ...
   private ViewHolder viewHolder;
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void loadData(int position) {
            ...
            String commentCount = String.valueOf(message.getMessageCount());
            if (!TextUtils.isEmpty(portrait)) {
                Picasso.with(context).load(portrait).into(viewHolder.ivIcon);
            }


            viewHolder.tvUsername.setText(message.getFriendName());
            viewHolder.tvContent.setText(message.getContent());
            viewHolder.tvTime.setText(message.getPubDate());
